...
local function split_tab_line(line)
  ...
  while #content > 0 do
    ...
    -- If we couldn't find a column end, use the full chunk size
    if end_pos == 0 then end_pos = chunk_size end
    
    -- Extract the chunk and add the prefix
    local chunk = prefix .. content:sub(1, end_pos)
